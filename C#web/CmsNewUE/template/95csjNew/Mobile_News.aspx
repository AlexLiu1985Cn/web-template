...
<DIV class="sub">
<DIV class="subnavbox">
[QH:loopFenYeT Show2=0 ,NowClass=checked,NowClassImg=showimg,FirstClass=first,LastClass=last, TitleNum=18]
<a title="公司简介" class="[QH:NowClass]" href="[QH:LinkPath]">[QH:FenLanTitle]<img class="[QH:NowClassImg]" alt="[QH:AltText]" src="[QH:PathPre]template/95csjNew/images/subicons.png"></a>[/QH:loopFenYeT]
</DIV>

<DIV class="subabout">
<div class="mobilenew">
[QH:loopPage NewsCount=20,TitleNum=18,AddStr=...,Condition=,Role=<hr />,KeyWord=,NewsType=]
  <a href="[QH:NewsPath]" title="[QH:AltText]" >[QH:Title] </a>
[/QH:loopPage]
