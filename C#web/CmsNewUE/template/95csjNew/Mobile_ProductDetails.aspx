...
<div class="subabout">
<div class="view_title">[QH:Title]</div>
<div class="view">
<p align="center"><img src="[QH:ThumbPicPath]" alt="[QH:Title]" /></p>
<p>产品编号：[QH:ProductID]</p>
<p>产品名称：[QH:Title]</p>
<p>产品规格：[QH:ProductSpecName]</p>
<p>产品类别：<a href="[QH:BackList]">[QH:ProductClass]</a></p>
<p>产品简介：[QH:BriefIntro]</p>
<h2>详细信息：</h2>
[QH:Contents]
...
<div class="clear"></div>
<div class="npage-p">
<div class="previous float2"><a title="上一条" href="[QH:PrevOneLink]">上一条</a></div>
<div class="previous float2"><a href="[QH:BackList]">返回列表</a></DIV>
<div class="previous float2"><a title="下一条" href="[QH:NextOneLink]">下一条</a></div>
