...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"../../net/imageUp.ashx"             //图片上传提交地址
...
//        ]
        , toolbars:[
            ['fullscreen', 'source',  'undo', 'redo', 
                'bold', 'italic', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch',  'blockquote', 'pasteplain',  'forecolor',  'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc',
                'lineheight','link', 'unlink', 'inserttable', 'mergecells', 'splittocells', 'touppercase', 'tolowercase',
                  'imagenone', 'imageleft', 'imageright',
