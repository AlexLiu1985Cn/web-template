<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateMng.aspx.cs" Inherits="CmsApp20.CmsBack.TemplateMng" %>
...
<div class="rightmain">当前位置：模板管理 >> <a href="TemplateMng.aspx?Mdl=0">模块模板设置</a></div>
<div class="rightmain1">二级位置：<%=strTemplate %></div>
<div class="rightmain1"> </div>
  ...
  <form id="form1" runat="server">
    ...
    <br />
        ...
        <asp:Button ID="BtnSaveList" runat="server" Text="保存列表修改" onclick="BtnSaveList_Click" CssClass ="BtnS"  OnClientClick ="return CheckNum();" />
    <br /><br />   
    栏目显示：<br />
    <%=strLanmu %>
    <br />
        <asp:HiddenField ID="HdnNumLM" runat="server" />
        <asp:Button ID="BtnSaveLM" runat="server" Text="保存栏目修改"   onclick="BtnSaveLM_Click"   CssClass ="BtnS" OnClientClick ="return CheckNumLM();" />
    <br /><br />   
    产品分类列表：<br />
    <%=strClass %>
    <br />
        <asp:HiddenField ID="HdnNumClass" runat="server" />
        <asp:Button ID="BtnSaveClass" runat="server" Text="保存分类列表修改"   onclick="BtnSaveClass_Click"   CssClass ="BtnS" OnClientClick ="return CheckNumClass();" />
    </div>
     <div id ="Btn" runat =server style =" margin:0 auto; width:840px;">
        <br /><br />
        <asp:Button ID="BtnEdit" runat="server" Text="编辑此模板" onclick="BtnEdit_Click" />
    </div>
    <div style ="display :none ;">
        <asp:HiddenField ID="HdnPath" runat="server" />
        <asp:Button ID="BtnCreateEmp" runat="server" Text="Button" 
            onclick="BtnCreateEmp_Click" />
    </div>
   </form>
</body>
</html>
