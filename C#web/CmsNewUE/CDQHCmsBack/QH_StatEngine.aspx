<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QH_StatEngine.aspx.cs" Inherits="CmsApp20.CmsBack.QH_StatEngine" %>
...
.form {border-top:1px solid #ccc; height:24px; 
background-color:#f4f4f4; line-height:20px; margin-left :10px; 
        }
</style>
</head>
...
<div class="rightmain">当前位置：访问统计 >> <a href="QH_StatEngine.aspx">搜索引擎分析</a></div>
<div class="rightmain1"> </div>
<div class="rightmain1"> </div>
     </div>
    </div> 
<table width="840px" align="center" cellpadding="2" cellspacing="2" bordercolor="#FFFFFF" >
  <tr><td height="30" bgcolor="#F2F2F2" style="z-index:5;">						
...
<button style='width:60px;height:18px;font-size:12px;margin:1px;border:1px solid #A4B3C8;background-color:#DFE7EF;' type=button onclick="CheckDate()">选择日期</button>
   ...
   <asp:Button ID="BtnOK" runat="server" Text="确认" onclick="BtnOK_Click"  OnClientClick ="$('HdnV').value='8';"/><asp:HiddenField ID="HdnV" runat="server" />
	</td></tr></table>
	<table width="840px" align="center" cellpadding="2" cellspacing="2" bordercolor="#FFFFFF" >
  <tr><td height="30" style="z-index:4">
	<strong>时段：</strong><%=strBegin %> - <%=strEnd %>
	</td></tr></table>
	
      <table width="840px" align="center" cellpadding="2" cellspacing="2" bordercolor="#FFFFFF" >
<tr><td style=" position:relative;z-index:0; text-align:center;">
...
<td><%#((string[])Container.DataItem)[0]%></td>
<td><%#((string[])Container.DataItem)[1]%></td>
<td><%#((string[])Container.DataItem)[2]%></td>
</tr>
</ItemTemplate>
