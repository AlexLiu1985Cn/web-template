...
function display()  //定义dateSelector的display方法，它将实现一个日历形式的日期选择框。
{
  ...
  document.write("<input style='text-align:center;width:80px;' id='DS_"+this.inputName+"' name='"+this.inputName+"' value='' title=双击可进行编缉 ondblclick='this.readOnly=false;this.focus()' onblur='this.readOnly=true' readonly >");//"+this.year+"-"+this.month+"-"+this.date+"
  ...
  document.write("  <div style='position:absolute;left:-60px;top:20px;width:142px;height:165px;background-color:#F6F6F6;border:1px solid #245B7D;z-index:100' class=ds_font>");
