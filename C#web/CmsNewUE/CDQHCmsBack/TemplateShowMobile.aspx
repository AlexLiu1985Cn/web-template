<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateShowMobile.aspx.cs"
    Inherits="CmsApp20.CmsBack.TemplateShowMobile" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        html, body
        {
            font: 12px/1.8 Tahoma, "微软雅黑" , 'Simsun';
            color: #333;
            background: #ffffff; /*#197bd9;*/
            padding-top: 10px;
        }
        a
        {
...
<body>
        ...
        <asp:Repeater ID="RD" runat="server" OnItemCommand="R1_ItemCommand" OnItemDataBound="R1_ItemDataBound">
            <ItemTemplate>
                <div class="temdan" id="deflst" runat="server">
                    ...
                    <b>作者</b>：<%# Eval("Designer")%><br />
                    <input type="hidden" id="SelectedID" runat="server" value='<%# Eval("id")%>' />
    ...
    <iframe src="http://www.95c.com.cn/TemplateWebsiteMobile.aspx" frameborder="0" width="100%"
        height="350" scrolling="no"></iframe>
    <%--localhost:134--%>
</body>
</html>
