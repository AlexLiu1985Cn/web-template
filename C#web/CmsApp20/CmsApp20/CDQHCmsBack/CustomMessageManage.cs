namespace CmsApp20.CDQHCmsBack
{
    ...
    public class CustomMessageManage : Page
    {
        ...
        {
            string str = "delete from QH_MessageCustom ";
            string str2 = "";
        ...
        protected void ButtondeleteSV_Clicked(object sender, EventArgs e)
        {
            ...
            {
                deletecount = this.Bll1.Delete("delete from QH_MessageCustom where id in(" + builder2.ToString().Substring(1) + ")");
            }
            if (deletecount > 0)
            {
        ...
        {
            return this.Bll1.DAL1.ExecuteReader("select count(*) as co from QH_MessageCustom " + ((string)this.ViewState["QWhere"]));
        }
        ...
        {
            string strQuery = "select * ,switch(readok=True,'是',readok=False,'否') as readok,switch(IsNull(Access)=True,'不限',Access='0','不限',Access='1','普通会员',Access='2','高级会员',Access='3','管理员') as Access from QH_MessageCustom " + ((string)this.ViewState["QWhere"]) + " order by id desc";
        ...
        public void ListBind()
        {
            ...
            string str = (base.Request.QueryString["id1"] == null) ? "" : base.Request.QueryString["id1"];
            string str2 = (base.Request.QueryString["id2"] == null) ? "" : base.Request.QueryString["id2"];
            string str3 = (base.Request.QueryString["id3"] == null) ? "" : base.Request.QueryString["id3"];
            string str4 = (base.Request.QueryString["Mdl"] == null) ? "" : base.Request.QueryString["Mdl"];
            this.strClmnID = (string)this.ViewState["ClmnID"];
            this.strBackUrl = "&id1=" + str + "&id2=" + str2 + "&id3=" + str3 + "&Mdl=" + str4;
